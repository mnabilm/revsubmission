...
# Memastikan 'season' dalam bentuk angka
if days_df["season"].dtype == "object":
    season_mapping = {"Spring": 1, "Summer": 2, "Fall": 3, "Winter": 4}
    days_df["season"] = days_df["season"].map(season_mapping)

# Sidebar Filter Musim
# Memastikan kolom 'season' bertipe integer
days_df["season"] = days_df["season"].astype(int)
...
if selected_season != "Semua":
    season_key = [key for key, value in seasons.items() if value == selected_season][0]
